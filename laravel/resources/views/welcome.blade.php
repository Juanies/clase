...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Hosting One Page Template</title>
									...
									<div class="single_home">
										<div class="col-sm-7">
											<div class="single_home_left">
												...
												<p>1 IP included with each server (more on request w/ justification)</p>
												<p>Your Choice of any OS (CentOS, Windows, Debian, Fedora)</p>
											</div>
										</div>
										<div class="col-sm-5">
											<div class="single_home_right">
												<a href=""><span>Call us :</span>  <strong>(818) 995-1560</strong></a>
												<a href=""><span>E-mail us :</span> <strong>XpeedStudio@gmail.com</strong> </a>
					...
					<div class="main_footerwidget">
						<div class="col-sm-2 col-xs-6">
							<div class="single_widget">
								<h4>Home</h4>
								<a href="" class="navbar-brande">Brand</a>
							</div>
						</div>
						<div class="col-sm-2 col-xs-6">
							<div class="single_widget">
